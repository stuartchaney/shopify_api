...
class VariantTest < Test::Unit::TestCase
  ...
  def test_setting_product_inventory_quantity_passes_in_api_before_2019_10
  ...
  def test_setting_product_inventory_quantity_fails_in_2019_10_api
  ...
  def test_setting_product_inventory_quantity_fails_in_the_unstable_api
